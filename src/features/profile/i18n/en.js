export default {
  profile: {
    ...
    completedClass: {
      ...
      noClassesFoundDesc: "Try adjusting your search keywords or switching filters.",
      noClassesTitle: "No completed classes yet",
      noClassesDesc: "You haven't completed any classes yet.",
      searchPlaceholder: "Search by class name, course, or instructor...",
      course: "Course",
      courseLabel: "Course: ",
      ...
      share: "Share",
      notShare: "Don't share",
      shared: "Shared",
      sharedLabel: "Shared",
      shareAchievement: "Share Achievement",
      displayed: "Displayed",
      hidden: "Hidden",
      allowProfileSharing: "Show on profile",
      allowProfileSharingDesc: "Public on your profile",
      allowProfileSharingDescOff: "Hidden from your profile",
      copyLink: "Copy certificate link",
      shareToPost: "Share to feed",
      featureInDev: "This feature is currently under development!",
      shareSuccess: "Certificate link copied to clipboard!",
      shareError: "Failed to share class",
      clearFilters: "Clear Filters",
      totalCount: "Total {count} completed classes",
    },
    review: {
      title: "Course Review",
