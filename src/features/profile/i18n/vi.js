export default {
  profile: {
    ...
    completedClass: {
      ...
      noClassesFoundDesc: "Thử điều chỉnh từ khoá tìm kiếm hoặc chuyển bộ lọc của bạn.",
      noClassesTitle: "Chưa có lớp học đã hoàn thành",
      noClassesDesc: "Bạn chưa hoàn thành bất kỳ lớp học nào.",
      searchPlaceholder: "Tìm kiếm theo tên lớp, khóa học hoặc giảng viên...",
      course: "Khóa học",
      ...
      needsReviewLabel: "Chờ đánh giá",
      completedLabel: "Đã hoàn thành",
      untitledClass: "Lớp học chưa đặt tên",
      filterAll: "Tất cả",
      filterNeedsReview: "Chưa đánh giá",
      filterReviewed: "Đã đánh giá",
      viewClass: "Xem tài liệu",
      ...
      sessions: "buổi",
      sessionsCompleted: "buổi hoàn thành",
      students: "học viên",
      standaloneClass: "Lớp học độc lập",
      share: "Chia sẻ",
      ...
      displayed: "Hiển thị",
      hidden: "Đã ẩn",
      allowProfileSharing: "Hiển thị trên hồ sơ",
      allowProfileSharingDesc: "Công khai trên hồ sơ của bạn",
      allowProfileSharingDescOff: "Đã ẩn khỏi hồ sơ của bạn",
      copyLink: "Sao chép liên kết chứng nhận",
      shareToPost: "Chia sẻ lên bài viết",
      featureInDev: "Tính năng đang được phát triển!",
      shareSuccess: "Đã sao chép liên kết chứng nhận hoàn thành lớp học!",
      shareError: "Không thể chia sẻ lớp học",
      clearFilters: "Xóa bộ lọc",
      totalCount: "Tổng cộng {count} lớp học đã hoàn thành",
    },
    review: {
