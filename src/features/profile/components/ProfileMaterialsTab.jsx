...
const ProfileMaterialsTab = ({ targetAccountId, isOwnProfile }) => {
  ...
  if (
    ...
    return <ProfileMaterialsSkeleton isOwnProfile={isOwnProfile} />
  }
      ...
      >
        {isOwnProfile && (
          <ChipFilter
            ...
            wrapDesktop={false}
            className="flex items-center gap-2 overflow-x-auto scrollbar-hidden"
          />
        )}
        ...
        <div className="flex flex-row items-center gap-2 shrink-0">
          ...
          >
            {viewLayout === "grid" ? <TableProperties /> : <LayoutGrid />}
          </IconButton>
        </div>
      </div>
      ...
      {filteredFolders.length === 0 && filteredFiles.length === 0 ? (
        ...
        <div className="flex flex-col gap-6">
          {filteredFolders.length > 0 && (
            <div>
              <h3 className="text-xl font-bold mb-4">{t.materials.folders}</h3>
              <div
                className={`grid gap-2 ${viewLayout === "grid" ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-1"}`}
              >
          ...
          {filteredFiles.length > 0 && (
            <div>
              <h3 className="text-xl font-bold mb-4">{t.materials.files}</h3>
              <div
                className={`grid gap-2 ${viewLayout === "grid" ? "grid-cols-1 sm:grid-cols-2 lg:grid-cols-3" : "grid-cols-1"}`}
              >
