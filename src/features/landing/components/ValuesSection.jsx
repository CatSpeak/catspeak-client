...
const ValuesSection = () => {
  ...
  return (
    <div className="w-full py-16 sm:py-24 relative overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:block relative min-h-[900px]">
          {/* Card 1 */}
          <div className="absolute left-[5%] top-[10%] transition-transform duration-500 hover:-translate-y-2">
            <ValueCard
              icon={<Play size={32} />}
          ...
          {/* Card 2 */}
          <div className="absolute left-[15%] top-[58%] transition-transform duration-500 hover:-translate-y-2">
            <ValueCard
              icon={<Users size={32} />}
          ...
          {/* Card 3 */}
          <div className="absolute left-1/2 -translate-x-1/2 top-[28%] transition-transform duration-500 hover:-translate-y-2">
            <ValueCard
          ...
          {/* Card 4 */}
          <div className="absolute right-[15%] top-[58%] transition-transform duration-500 hover:-translate-y-2">
            <ValueCard
          ...
          {/* Card 5 */}
          <div className="absolute right-[5%] top-[10%] transition-transform duration-500 hover:-translate-y-2">
            <ValueCard
              icon={<Network size={32} />}
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-10 lg:hidden">
          <ValueCard
            ...
            description="Game và hệ thống kết nối theo từng cấp độ và nhu cầu học tập khác nhau để phù hợp với cá nhân."
            color="orange"
            className=""
          />
