...
export const RESOURCE_CATEGORIES = {
  ...
  test: { labelEn: "Practice Tests", labelZh: "模拟考试", icon: BookOpenCheckIcon },
  platform: { labelEn: "Learning Platforms", labelZh: "综合平台", icon: LibraryBig },
  ...
  pronunciation: { labelEn: "Pronunciation", labelZh: "发音与拼音", icon: MicVocal },
  news: { labelEn: "News & Articles", labelZh: "分级阅读与新闻", icon: Newspaper },
  exam: { labelEn: "IELTS / HSK Prep", labelZh: "备考专区", icon: BookOpenCheck },
  reading: { labelEn: "Graded Readers", labelZh: "阅读拓展", icon: BookOpenText },
  dictionary: { labelEn: "Dictionaries", labelZh: "实用词典", icon: LibraryBig },
    ...
    subItems: [
      {
        ...
        color: "#db008f",
        description: "Free standardized English test with instant score report aligned to CEFR levels.",
      },
      {
        ...
        color: "#5acc02",
        description: "Official practice portal for the digital Duolingo English proficiency test.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Comprehensive video-based platform to learn English online for free.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#003366",
        description: "Over 3,000 free listening activities with transcripts and quizzes for all levels.",
      },
      {
        ...
        color: "#124c75",
        description: "Everyday conversation audio quizzes for beginner, intermediate, and advanced learners.",
      },
      {
        key: "esl-yes",
        label: "ESL Yes",
        ...
        color: "#00bf00",
        description: "1,600+ short audio stories with scripts and vocabulary practice.",
      },
      {
        key: "esl-podcast",
        ...
        color: "#8bc73e",
        description: "Slow, clear English podcasts explaining cultural context and idioms.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#00918a",
        description: "Clear explanations and interactive exercises for English verb tenses & grammar rules.",
      },
      {
        ...
        description: "Free online grammar, vocabulary, reading, and listening exercises.",
      },
      {
        key: "learngrammar",
    ...
    subItems: [
      {
        ...
        color: "#4255ff",
        description: "Create and study digital flashcards, practice tests, and interactive memory games.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#edba1f",
        description: "AI-powered pronunciation scoring and speaking practice assistant.",
      },
      {
        key: "youglish",
        label: "YouGlish",
        ...
        color: "#d12121",
        description: "Search YouTube clips to hear real native speakers pronounce any word or phrase.",
      },
      {
        key: "howtopronounce",
        ...
        color: "#a4cc37",
        description: "Audio pronunciation dictionary featuring global accents and audio recordings.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "World news articles written in 3 different English difficulty levels with audio.",
      },
      {
        key: "breaking-news-english",
        label: "Breaking News English",
        path: "/website/breaking-news-english",
        description: "Free interactive lessons on current events with 7 levels of difficulty.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Short 10-minute IELTS Reading and Listening practice tests with answers.",
      },
      {
        ...
        description: "Full mock exams and practice exercises for Academic and General IELTS.",
      },
      {
        key: "alfa-ielts",
        label: "Alfa IELTS",
        ...
        description: "AI-evaluated IELTS practice platform for speaking and writing modules.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#009900",
        description: "Fun science, animal articles, and educational games for younger learners.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Free online English lessons, reading comprehension, and song quizzes.",
      },
      {
        key: "free-graded-readers",
        label: "Free Graded Readers",
        path: "/website/free-graded-readers",
        description: "E-books adapted for English learners at various proficiency levels.",
      },
      {
        ...
        description: "Extensive online library of graded readers in EPUB, MOBI, and FB2 formats.",
      },
      {
        ...
        description: "Resources and reading lists to promote pleasure reading in foreign languages.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#398596",
        description: "Clear definitions, example sentences, and audio pronunciations for English learners.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Free audio courses using Thinking Method to master language structures quickly.",
      },
    ],
  },
    ...
    subItems: [
      {
        ...
        description: "Kho sách giáo khoa & học liệu số chuẩn NXB Giáo dục Việt Nam.",
      },
      {
        key: "hoc10",
        label: "Hoc10",
        ...
        color: "#304a59",
        description: "Nền tảng sách giáo khoa điện tử Cánh Diều và bài tập tương tác.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Complete online HSK 1–6 practice tests with answers and listening audio.",
      },
      {
      ...
      },
      {
        ...
        description: "Simulated HSK exam environment to practice timing and scoring.",
      },
      {
        ...
        description: "Free official sample test papers for all HSK proficiency levels.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        img: "https://mandarinbean.com/wp-content/uploads/2019/06/mb_2.png",
        description: "Comprehensive Chinese learning portal covering grammar, reading, and listening.",
      },
      {
        ...
        img: "https://improvemandarin.com/wp-content/uploads/cropped-improvemandarin-favicon-1-192x192.png",
        description: "Bite-sized Chinese grammar guides, pinyin tips, and culture articles.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        img: "https://mandarinbean.com/wp-content/uploads/2019/06/mb_2.png",
        description: "Graded listening audio lessons with pinyin and English translations.",
      },
      {
        ...
        description: "Authentic audio practice for upper-intermediate Chinese learners.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "The premier free reference guide for Mandarin grammar rules and sentence structures.",
      },
      {
        ...
        img: "https://mandarinbean.com/wp-content/uploads/2019/06/mb_2.png",
        description: "Grammar points categorized by HSK levels with practical examples.",
      },
      {
        ...
        img: "https://mandarinbean.com/wp-content/uploads/2019/06/mb_2.png",
        description: "Test your Mandarin grammar accuracy across different difficulty levels.",
      },
      {
        ...
        description: "Easy-to-understand explanations of complex Mandarin sentence patterns.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        img: "https://resources.allsetlearning.com/favicon.ico",
        description: "Complete guide to Pinyin, initials, finals, and tone change rules.",
      },
      {
        ...
        description: "Interactive audio Pinyin chart and tone discrimination drills.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        description: "Animated Chinese character stroke order diagrams and stroke count.",
      },
      {
        key: "arch-chinese",
        label: "ArchChinese",
        ...
        description: "Premier learning system for Chinese character handwriting and stroke animation.",
      },
      {
        key: "hanzi-guide",
        label: "Hanzi Guide",
        ...
        description: "Etymology and component breakdown of Chinese Hanzi characters.",
      },
      {
        key: "hanzi-stroke",
        ...
        description: "Step-by-step character writing guides and printable practice sheets.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#4b66a3",
        description: "Popular online English-Chinese dictionary with Pinyin, audio, and character lookups.",
      },
    ],
  },
  {
    ...
    subItems: [
      {
        ...
        color: "#870430",
        description: "Website tự học tiếng Trung giao diện tiếng Việt dễ hiểu cho người mới bắt đầu.",
      },
    ],
  },
];
