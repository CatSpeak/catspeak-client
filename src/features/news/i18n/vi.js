export default {
  news: {
    ...
    empty: {
      ...
      description: "Hiện tại chưa có bài đăng nào trong bản tin thế giới. Hãy quay lại sau!",
    },
    viewMode: {
      post: "Dạng bài đăng",
    ...
    newsDetail: {
      ...
      relatedNews: "Bản tin liên quan",
      viewAll: "Xem tất cả",
      noRelatedNews: "Không có bản tin liên quan.",
    },
    newsCard: {
