      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-8 text-[15px] sm:text-base leading-relaxed text-gray-800">
          ...
          <div className="space-y-5">
            <p className="text-gray-700">{workshop.introText}</p>
          ...
          <div className="space-y-4 bg-gradient-to-br from-yellow-50 to-orange-50/30 p-5 rounded-xl border border-yellow-100 shadow-sm">
             <div className="flex items-center gap-2 text-[#990011]">
               <Gift className="w-5 h-5" />
               <p className="font-bold">{workshop.specialGiftsIntro}</p>
             </div>
             <ul className="space-y-2.5 pl-1">
          ...
          <div className="space-y-4">
             <p className="font-bold text-lg text-gray-900">
                {workshop.speakerLabel} <span className="text-[#990011]">{workshop.speakerName}</span>
             </p>
             <ul className="space-y-2.5 pl-1">
              {(workshop.speakerTitles || []).map((point, idx) => (
                <li key={idx} className="flex items-start gap-2.5 text-gray-700">
                  <ChevronRight className="w-5 h-5 text-[#990011] shrink-0 mt-0.5" />
                  <span>{point}</span>
                </li>
              ))}
            </ul>
          ...
          {/* Social Section */}
          <div className="pt-2">
            <p className="font-semibold text-gray-900 mb-4 whitespace-pre-wrap text-center">{workshop.followPrompt}</p>
