    ...
    >
      <div className="flex flex-col gap-6">
        ...
        <div className="space-y-8 text-[15px] sm:text-base leading-relaxed text-gray-800">
          ...
          {/* Workshop Title */}
          <div className="py-3 px-4 bg-gray-50/80 rounded-xl border border-border">
          ...
          <div className="pt-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <a
                ...
                className="flex flex-col items-center gap-2 p-4 rounded-xl border border-border hover:border-red-200 hover:bg-red-50/30 transition-colors group"
              >
