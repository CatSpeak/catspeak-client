  ...
  return [
    {
      ...
      subtext: t.workshops.hskWorkshop
        ? `${t.workshops.hskWorkshop.introText1} ${t.workshops.hskWorkshop.introText2}`
        : "",
    ...
    },
    {
      ...
      subtext: t.workshops.chinaWorkshop
        ? `${t.workshops.chinaWorkshop.introText} ${t.workshops.chinaWorkshop.introHighlight} ${t.workshops.chinaWorkshop.introClosing}`
        : "",
    ...
    },
    {
      ...
      subtext: t.workshops.scholarshipWorkshop
        ? t.workshops.scholarshipWorkshop.introText
        : "",
