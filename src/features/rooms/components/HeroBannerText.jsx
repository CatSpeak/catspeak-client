...
const HeroBannerText = ({ sessionProps }) => {
  const { t } = useLanguage()
  ...
  return (
    <div className="col-span-12 md:col-span-6 flex flex-col justify-between px-8 pt-6 pb-6 md:pr-4">
      {/* Doodle logo */}
      <img src={doodles} alt="Cat Speak doodles" className="relative top-[-30px] w-52 mb-4 object-contain object-left" />
      
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-5xl sm:text-5xl font-extrabold text-gray-900 font-nunito leading-relaxed w-full">
            {renderTitle()}
          </h1>
          <p className="text-gray-600 text-lg mt-3 leading-relaxed max-w-full font-nunito">
          ...
          <p className="text-gray-500 text-2xl mt-2 font-bold italic font-nunito">{t.rooms?.welcome?.trickOrTreat || "Trick or Treat"}</p>
        </div>
