...
import { Send, ChevronDown, LayoutGrid, Wind } from "lucide-react"
...
const StoryInputBar = ({
  ...
  const sortLabel = sortOrder === "newest" ? "Mới nhất" : "Cũ nhất"
    ...
    <div className="mb-2 flex flex-col md:flex-row items-center justify-between gap-3 px-1 pt-1 -mx-1 -mt-1">
      ...
      <div className="flex w-full items-start gap-2">
        ...
        <button
          type="button"
          onClick={onSend}
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-cath-red-700 text-white transition hover:brightness-90 active:brightness-75"
