...
export const useRoleOverride = () => {
  ...
  const { data: profileWithAccountType, refetch: refetchAccountType } =
    useGetUserProfileHaveAccountTypeQuery()

  const profile = profileResponse?.data ?? profileResponse
  const profileWithAccountTypeData =
    profileWithAccountType?.data ?? profileWithAccountType
  ...
  const currentRole =
    backendAccountType || (isTeacherProfile ? "Teacher" : "Student")
