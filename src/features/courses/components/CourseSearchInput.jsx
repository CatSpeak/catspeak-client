  ...
  return (
    <div className={`relative ${className}`}>
      <input
        ...
        className="w-full h-8 pl-4 pr-10 bg-white hover:bg-gray-50/50 focus:bg-white border border-border focus:border-gray-300 outline-none rounded-xl text-sm font-semibold text-gray-800 transition-all placeholder:text-gray-400 shadow-xs"
      />
