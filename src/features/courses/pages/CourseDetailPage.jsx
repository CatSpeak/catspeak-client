                ...
                classes.map((cls) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-white border border-gray-100 hover:border-gray-200 rounded-3xl overflow-hidden shadow-xs hover:shadow-md transition-all duration-300 cursor-pointer flex flex-col justify-between"
                    >
