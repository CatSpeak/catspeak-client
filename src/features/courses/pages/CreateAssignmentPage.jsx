        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <div className="flex flex-col gap-6 bg-white border border-border rounded-3xl p-6 shadow-xs">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Dropdown
                options={[
                  { value: "all", label: ca.allFormats || "Tất cả định dạng" },
                  { value: "PDF", label: "PDF" },
                ...
                placeholder={ca.allFormats || "Tất cả định dạng"}
                  ...
                  {allowedFileTypes.map((type) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="hover:text-orange-950 transition-colors cursor-pointer"
                      >
            ...
            <div className="flex flex-col gap-2">
              ...
              <Dropdown
                options={[
                  { value: "scale10", label: ca.scale10 || "Thang điểm 10" },
                  { value: "scale100", label: ca.scale100 || "Thang điểm 100" },
                ]}
                value={gradeScale}
                onChange={(val) => setField("gradeScale", val)}
                roundedClass="rounded-xl"
                className="w-full"
                triggerClassName="!h-10"
                dropdownClassName="w-full min-w-[200px]"
            ...
            <div className="flex flex-col gap-2">
              ...
              <Dropdown
                options={[
                  { value: "manual", label: ca.releaseManual || "Công bố thủ công" },
                  { value: "automatic", label: ca.releaseAutomatic || "Tự động công bố sau khi chấm" },
                ]}
                value={resultRelease}
                onChange={(val) => setField("resultRelease", val)}
                roundedClass="rounded-xl"
                className="w-full"
                triggerClassName="!h-10"
                dropdownClassName="w-full min-w-[200px]"
