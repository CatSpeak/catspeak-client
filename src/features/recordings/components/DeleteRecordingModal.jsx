  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1">
        <div className="flex flex-col items-center justify-center flex-1 text-center gap-4 max-h-[60vh] overflow-y-auto -mx-3 px-3 scrollbar-app-transparent max-[425px]:max-h-none">
          {/* Warning icon */}
