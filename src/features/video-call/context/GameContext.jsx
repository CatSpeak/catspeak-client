...
export const GameProvider = ({ children, roomLanguage = "en" }) => {
    ...
    const connection = useGameSignaling({
        ...
        RATING_OPEN: (payload) => {
            ...
            setPictureItState(prev => ({ ...prev, ratingOpen: true, ratingCountdownSec: seconds }));
        ...
        SYNC_GAME_STATE: (payload) => {
            ...
            if (payload.game_type === "picture_it") {
                ...
                setPictureItState(prev => ({
                    ...
                    forbiddenWords: isDescriber ? (payload.current_round?.forbidden_words || []) : [],
    ...
    useEffect(() => {
        const handleHostStart = (e) => {
            if (gameState === "idle") {
                ...
                startGame(detail.gameId || "crack_it", detail.level || "easy", detail.language);
            }
        };
