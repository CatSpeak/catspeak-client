...
const ScreenShareTile = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`relative flex h-full w-full items-center justify-center overflow-hidden rounded-2xl border border-[#E5E5E5] bg-neutral-900 shadow-sm ${onClick ? "cursor-pointer" : ""}`}
    >
      <video
        autoPlay
        playsInline
