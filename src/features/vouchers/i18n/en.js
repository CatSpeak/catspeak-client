export const en = {
  vouchers: {
    ...
    form: {
      ...
      maxDiscountHelper: "Maximum discount amount per enrollment (minimum 2,000 ₫).",
      maxDiscountEquivalent: "Equivalent to {{nominal}} with {{percent}}% of tuition ({{tuition}}).",
      maxBudgetHelper: "Voucher automatically stops when total discount given reaches this limit (minimum 2,000 ₫).",
      usageLimitAutoCalc: "Auto-calculated: {{budget}} ÷ {{discount}} = {{uses}} usages.",
      usageLimitAutoCalcHelper: "Auto-calculated based on Max Budget ÷ Discount Value.",
    ...
    errors: {
      ...
      budgetLowerThanDiscount: "Max budget must be greater than or equal to the discount value ({{amount}})",
      budgetTooLowForUsage: "Max budget must be sufficient to cover at least 1 usage",
    },
    ...
    noticeModal: {
      ...
      noClassesBody: "Course {{courseName}} currently has no classes. Please create at least 1 class before creating vouchers.",
