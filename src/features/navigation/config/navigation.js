...
export const navLinks = [
  ...
  { key: "myCourses", path: "/workspace/courses", icon: GraduationCap, requiresAuth: true, showOnHorizontalBar: false },
  { key: "myClass", path: "/workspace/classes", icon: Users, requiresAuth: true, showOnHorizontalBar: false },
  { key: "schedule", path: "/workspace/schedule", icon: Calendar, requiresAuth: true, showOnHorizontalBar: false },
  { key: "analytics", path: "/workspace/analytics", icon: BarChart, requiresAuth: true, showOnHorizontalBar: false },
  {
    key: "workspace",
    hasDropdown: true,
    icon: Briefcase,
