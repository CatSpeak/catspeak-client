      ...
      <div className="flex justify-between items-start">
        <div className='space-y-3'>
          <div className="flex items-center gap-3">
            ...
            <div className='border border-[#D1D5DB] text-[#4B5563] text-xs uppercase px-2 py-0.5 font-semibold rounded'>Danh từ</div>
            <div className='bg-[#EFF6FF] border border-[#BFDBFE] text-[#1D4ED8] text-xs uppercase px-2 py-0.5 font-semibold rounded'>EN</div>
          </div>
            ...
            {word.teacherNote && (
              <div className="bg-[#fffcf1] p-4 rounded-xl border-l-4 border-[#f59e0b]">
                <div className="flex items-center gap-1">
                  ...
                  <p className="text-sm font-bold text-[#92400E] uppercase">Ghi chú từ giáo viên</p>
                </div>
            ...
            <div className='flex items-center justify-between'>
              {word.relatedWords && word.relatedWords.length > 0 && (
                <div className="flex items-center gap-2 flex-wrap mt-1">
                  <span className="text-sm text-[#9CA3AF] mr-1">Từ liên quan:</span>
              ...
              <div className='flex items-center gap-2'>
                <div className='flex items-center gap-1'>
                  ...
                  <span className="text-sm text-[#6B7280] font-medium">Script: Happy Halloween,</span>
                </div>
