...
import QuickRejoinWidget from "@/features/video-call/components/QuickRejoinWidget"
...
export const BottomRightStack = () => {
  return (
    <div className="fixed bottom-6 right-6 z-[9998] flex flex-col-reverse items-end gap-3.5 pointer-events-none max-w-[390px] w-full">
      ...
      {/* QuickRejoinWidget arrives and takes the bottom position, pushing items up */}
      <QuickRejoinWidget embedInStack={true} />
    </div>
  )
}
