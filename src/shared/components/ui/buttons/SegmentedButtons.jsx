            ...
            <div
              className={`w-full h-10 px-4 text-sm font-medium flex items-center justify-center gap-2 transition whitespace-nowrap border ${roundedClasses} ${
                isSelected
                  ...
                  : "bg-white dark:bg-neutral-800 border-border dark:border-neutral-700 text-neutral-600 dark:text-neutral-400 group-hover:bg-primaryBg dark:group-hover:bg-neutral-700 group-hover:text-neutral-900 dark:group-hover:text-white"
              }`}
            >
