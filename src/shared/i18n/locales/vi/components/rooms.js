export default {
  ...
  coHost: {
    ...
    permissionHelpers: {
      ...
      manage_student_share: "Quản lý quyền chia sẻ màn hình của học viên",
    ...
    permissionHelpersRoom: {
      ...
      manage_student_share: "Quản lý quyền chia sẻ màn hình của thành viên",
    ...
    permissions: {
      ...
      manage_student_share: "Quản lý quyền chia sẻ màn hình/cửa sổ của học viên",
    ...
    permissionsRoom: {
      ...
      share_screen: "Chia sẻ màn hình/cửa sổ",
      manage_student_share: "Quản lý quyền chia sẻ màn hình/cửa sổ của thành viên",
      record: "Bắt đầu/dừng ghi hình",
    },
    errors: {
