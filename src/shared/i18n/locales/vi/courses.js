export default {
  ...
  analytics: {
    ...
    studentDetail: {
      ...
      totalWordsSpoken: "Tổng số từ đã nói",
      avgWordsPerSession: "Trung bình {{avg}} từ/buổi",
    ...
    sessionDetail: {
      ...
      kpiTotalWordsDuration: "Tổng từ & Thời lượng",
      ...
      tableDesc: "Thống kê chi tiết thời lượng, số từ và trạng thái phát biểu của từng học viên trong buổi học.",
      colStudent: "Học viên",
