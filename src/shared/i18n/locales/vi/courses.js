export default {
  ...
  analytics: {
    ...
    classDetail: {
      ...
      teacherDisclaimer: "Giáo viên không được tính vào STB — chỉ thời gian phát biểu của học viên được thống kê.",
      ...
      clickStudentHint: "› Click học viên để xem lịch sử phát biểu từng buổi của học viên đó",
    ...
    studentDetail: {
      ...
      clickSessionHint: "› Click vào buổi để xem báo cáo đầy đủ của cả lớp trong buổi đó (sc19)",
