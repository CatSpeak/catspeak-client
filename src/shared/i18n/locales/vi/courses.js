export default {
  ...
  course: "Khóa học",
  class: "Lớp học",
  courseBadge: "Khóa học",
  classBadge: "Lớp học",
  tuition: "Học phí",
  closingSoon: "Sắp đóng tuyển sinh",
  slotsRemaining: "Còn {{count}} chỗ",
  ...
  viewAll: "Xem tất cả",
  allTeachingTasksTitle: "Nhiệm vụ giảng dạy",
  taskTabUrgent: "Khẩn cấp",
  taskTabRequired: "Cần làm",
  taskTabLater: "Xử lý sau",
  taskColCoverImage: "Ảnh bìa",
  taskColBelongsToCourse: "Thuộc khóa học",
  taskColTaskDescription: "Mô tả nhiệm vụ",
  taskColDueTime: "Hạn (giờ)",
  taskColDueDate: "Hạn (ngày)",
  taskColAction: "Thao tác",
  taskViewDetails: "Xem chi tiết",
  taskPendingCount: "{{count}} đang chờ",
  taskLoadError: "Không thể tải nhiệm vụ giảng dạy. Vui lòng thử lại.",
  taskNoResults: "Không tìm thấy nhiệm vụ nào.",
  taskRetry: "Thử lại",
  priceLabel: "Giá cả",
  free: "Miễn phí",
  classCount: "{{count}} lớp",
  noClasses: "Chưa có lớp",
  studentsCount: "{{count}} học viên",
  teachingStatus: "Đang dạy",
  ...
  analytics: {
    ...
    classDetail: {
      breadcrumbAnalytics: "Phân tích",
      metaSubtitle: "STB Chi tiết · {{term}} · {{students}} học viên · {{sessions}} buổi",
      avgClassStb: "STB Trung bình cả lớp",
      overSessions: "Trên {{count}} buổi học",
      belowThreshold: "Học viên dưới ngưỡng (< {{rate}}%)",
      studentsUnit: "học viên",
      needsAttention: "Cần được chú ý thêm",
      totalSessionsLearned: "Tổng buổi đã học",
      tabByStudent: "Theo học viên",
      tabBySession: "Theo buổi",
      colStudent: "Học viên",
      colAvgPercent: "% TB",
      colSessionsMet: "Buổi đạt",
      colSessionsUnmet: "Buổi chưa đạt",
      colTrend: "Xu hướng",
      colStatus: "Trạng thái",
      sessionsCount: "{{count}} buổi",
      trendImproving: "Cải thiện",
      trendStable: "Ổn định",
      trendDeclining: "Giảm dần",
      statusNormal: "Bình thường",
      statusAttention: "Cần chú ý",
      statusWarning: "Cảnh báo",
      expectedThresholdHint: "Ngưỡng kỳ vọng: mỗi học viên phát biểu ≥ {{rate}}% thời gian (kỳ vọng cân bằng 1/{{total}} học viên)",
      session: "Buổi học",
      teacherTalk: "GV",
      studentTalk: "HV",
      wordsCount: "{{count}} từ",
      colDate: "Ngày",
      colEndTime: "Giờ kết thúc",
      colRatio: "Tỷ lệ GV / HV",
      colAvgStb: "STB TB",
      colStatus: "Trạng thái",
      sessionNotEnded: "Chưa kết thúc",
      noSessions: "Chưa có dữ liệu buổi học nào được ghi nhận.",
      details: "Chi tiết",
      drawerTitle: "Lịch sử phát biểu học viên",
      drawerAvg: "STB Trung bình",
      drawerSessions: "Số buổi tham gia",
      drawerMetRatio: "Tỷ lệ buổi đạt",
      timeline: "Tiến trình qua các buổi học",
      close: "Đóng",
    },
    studentDetail: {
      breadcrumbClass: "Chi tiết lớp học",
      historyTitle: "Lịch sử phát biểu — {{name}}",
      historySubtitle: "{{className}} · {{term}} · {{sessions}} buổi tham gia",
      avgSpeechPercent: "% Phát biểu TB",
      classExpected: "Kỳ vọng lớp: {{rate}}%",
      sessionsMetThreshold: "Buổi đạt ngưỡng",
      showingRecentSessions: "Hiển thị {{count}} buổi gần nhất",
      totalSpeakingDuration: "Tổng thời lượng phát biểu",
      avgDurationPerSession: "Trung bình {{avg}}/buổi",
      recentTrend: "Xu hướng gần đây",
      trendImproving: "Cải thiện",
      trendStable: "Ổn định",
      trendDeclining: "Giảm dần",
      recentSessionResult: "Buổi {{session}}: chỉ đạt {{rate}}%",
      recentSessionResultGood: "Buổi {{session}}: đạt {{rate}}%",
      latestSessionResult: "Buổi gần nhất: chỉ đạt {{rate}}%",
      latestSessionResultGood: "Buổi gần nhất: đạt {{rate}}%",
      latestSessionAvg: "Buổi gần nhất: {{rate}}%",
      warningBanner: "Học viên này có {{unmet}}/{{total}} buổi gần đây chưa đạt ngưỡng và đang có xu hướng giảm — cân nhắc hỗ trợ thêm.",
      sectionHistory: "Lịch sử theo buổi học",
      colSession: "Buổi học",
      colDate: "Ngày",
      colEndTime: "Giờ kết thúc",
      colDuration: "Tổng thời lượng nói",
      colSpeechPercent: "% Phát biểu",
      colExpected: "Kỳ vọng",
      colStatus: "Trạng thái",
      statusMet: "Đạt",
      statusUnmet: "Chưa đạt",
      showingSessionsCount: "Hiển thị {{count}} / {{total}} buổi",
      prev: "← Trước",
      next: "Sau →",
    },
    sessionDetail: {
      breadcrumbAnalytics: "Phân tích",
      breadcrumbSession: "Buổi học ({{date}})",
      sessionDetail: "Chi tiết buổi học",
      sessionTitle: "Buổi học · {{date}}",
      timePrefix: "Thời gian:",
      loading: "Đang tải dữ liệu phân tích buổi học...",
      aggregatingTitle: "Buổi học đang tổng hợp dữ liệu",
      aggregatingDesc: "Buổi học cần một thời gian ngắn để đóng hẳn và tổng hợp dữ liệu. Vui lòng quay lại sau.",
      kpiSpeechRatio: "Tỷ lệ phát biểu (GV / HV)",
      kpiTotalDuration: "Tổng thời lượng phát biểu",
      kpiParticipatingStudents: "Học viên tham gia",
      teacherTag: "GV",
      studentTag: "HV",
      durationHint: "Thời gian học viên phát biểu",
      durationPrefix: "Thời gian:",
      studentsUnit: "học viên",
      belowThresholdCount: "{{count}} học viên dưới ngưỡng",
      zeroBelowThreshold: "0 học viên dưới ngưỡng",
      statusIdeal: "Trạng thái: Lý tưởng",
      statusTooMuch: "Trạng thái: Nói nhiều",
      statusTooLittle: "Trạng thái: Nói ít",
      statusNormal: "Trạng thái: Bình thường",
      tableTitle: "Dữ liệu phát biểu học viên",
      tableDesc: "Thống kê chi tiết thời lượng và trạng thái phát biểu của từng học viên trong buổi học.",
      colStudent: "Học viên",
      colSpeechPercent: "% Phát biểu (STB)",
      colSpeakingDuration: "Thời lượng nói",
      colStatus: "Trạng thái",
      statusMet: "✓ Đạt",
      statusUnmet: "Chưa đạt",
      noStudentData: "Chưa có dữ liệu phát biểu của học viên trong buổi học này.",
    },
  },
  dashboard: {
    title: "Bảng điều khiển",
    subtitle: "Tổng quan hoạt động giảng dạy của bạn trong nháy mắt.",
    viewingPeriod: "Khoảng thời gian xem",
    ...
    compareOptions: {
      previous: "Kỳ trước",
      lastYear: "Cùng kỳ năm ngoái",
      none: "Không so sánh",
    },
    metrics: {
      totalRegistrations: "Tổng đăng ký",
      teachingHours: "Giờ giảng dạy",
      completedSessions: "Buổi học hoàn thành",
      avgSessionDuration: "Thời lượng TB / Buổi",
      minutes: "phút",
      hours: "giờ",
      sessions: "phiên",
      platformFeeRate: "Phí nền tảng 5%",
      sessionsActive: "Đang diễn ra",
      sessionsUpcoming: "Sắp tới",
      sessionsCompleted: "Đã hoàn thành",
      sessionsCancelled: "Đã hủy",
      topCourseRevenue: "Khóa học có doanh thu/buổi cao nhất",
      reenrollment: "Tỷ lệ đăng ký lại",
    },
    sections: {
      students: "Học viên",
      studentsSubtitle: "Tổng quan về học viên trong kỳ đã chọn",
      studentGrowth: "Tăng trưởng học viên",
      topStudents: "Top 3 lớp theo học viên",
      revenue: "Doanh thu",
      revenueSubtitle: "Doanh thu phát sinh trực tiếp ở cấp lớp",
      revenueTrend: "Xu hướng doanh thu",
      topRevenue: "Top 3 lớp theo doanh thu",
      performance: "Hiệu quả giảng dạy",
      performanceSubtitle: "Ảnh chụp hoạt động trong kỳ này",
      sessionVolume: "Buổi học theo trạng thái",
      courseClass: "Khóa học & Lớp học",
      courseClassSubtitle: "Hiệu quả vận hành và tỷ lệ lấp đầy lớp",
      topFillRate: "Top 3 lớp theo tỷ lệ lấp đầy",
      quality: "Chất lượng giảng dạy",
      qualitySubtitle: "Chất lượng sau khi học và sức hút trước khi đăng ký",
  ...
  studentCourseDetail: {
    ...
    noClassDescription: "Chưa có thông tin mô tả chi tiết cho lớp học này.",
    ...
    registeredStudentsLabel: "Học viên đã đăng ký",
    ...
    tabAllClasses: "Các lớp học hiện có ({{count}})",
    ...
    language: "Ngôn ngữ",
    defaultLanguage: "Tiếng Anh",
    aboutCourse: "Về khóa học",
    noCourseDescription: "Chưa có thông tin mô tả chi tiết cho khóa học này.",

    // Teacher Card
    profileBtn: "Trang cá nhân",
    messageTeacher: "Nhắn tin với giảng viên",
    rating: "Đánh giá",
    ...
    viewClassDetails: "Xem chi tiết",
    viewClassDetailsNewTab: "Xem chi tiết lớp học trong tab mới",
    collapse: "Thu gọn",
    remainingSlotsText: "Còn {{remaining}}/{{total}} chỗ",
    remainingSlotsLabel: "Số người đã đăng ký",
    levelLabel: "Trình độ",
    defaultLevel: "Cơ bản",
    enrollmentPeriod: "Thời gian đăng ký",
    aboutClass: "Về lớp học",
    weeklySchedule: "Lịch học hàng tuần",
    studentsUnit: "học viên",
    reviewsUnit: "đánh giá",
    priceFree: "Miễn phí",
    goToWorkspace: "Vào học →",
    enrolledBadge: "Đã tham gia",
    alreadyEnrolledInCourse: "Đã đăng ký khóa này",
    classFull: "Đã đủ học viên",
    enrollmentClosed: "Đã đóng đăng ký",
    upcomingStatus: "Chưa mở đăng ký",
    enrollmentUnavailable: "Chưa mở đăng ký",
    register: "Đăng ký",
    processing: "Đang xử lý...",
    loginToEnroll: "Vui lòng đăng nhập để đăng ký lớp học.",
    chatOpenFailed: "Không thể mở hộp thoại.",
  ...
  classDetail: {
    ...
    toastCancelSuccess: "Xóa lớp học thành công!",
    toastCancelFailed: "Không thể Xóa lớp học",
    ...
    searchMembers: "Tìm kiếm học viên...",
    ...
    noStudentsHint: "Mời học viên tham gia lớp để bắt đầu giảng dạy.",
    assistantLabel: "Trợ giảng",
    resultsCount: "{{count}} kết quả",
    clearSearch: "Xóa tìm kiếm",
    viewProfile: "Xem hồ sơ",
    sortAsc: "Sắp xếp tăng dần theo tên (A-Z)",
    sortDesc: "Sắp xếp giảm dần theo tên (Z-A)",
  ...
  createCourse: {
    ...
    avatarDesc2: "PNG, JPG, WEBP (tối đa 5MB)",
    ...
    descriptionTooLong: "Nội dung mô tả không được vượt quá 150 từ.",
  ...
  createClass: {
    ...
    language: "Ngôn ngữ",
    level: "Trình độ",
    admissionPeriod: "Thời gian tuyển sinh",
    startDate: "Thời gian bắt đầu",
    retentionPeriod: "Thời gian lưu trữ lớp sau kết thúc",
    daysUnit: "ngày",
    ...
    avatarDesc1: "Hỗ trợ định dạng PNG, JPEG và WebP",
    avatarDesc2: "Kích cỡ tối đa 5MB",
    editClass: "Chỉnh sửa lớp học",
    ...
    noScheduleSelected: "Chưa có lịch dạy nào được cấu hình.",
    reopenClass: "Mở lại lớp học (Khôi phục)",
    classInformation: "Thông tin lớp học",
    ...
    requireMinAttendanceTooltip: "Học viên cần tham dự tối thiểu tỷ lệ số buổi này để đủ điều kiện hoàn thành lớp học.",
    minAttendanceRateLabel: "Tỷ lệ tham dự tối thiểu",
    requireAttendanceTypeLabel: "Yêu cầu Lần tham dự",
    requireAttendanceTypeTooltip: "Quy định cách tính khi học viên vào lớp muộn: có tính vào buổi tham dự hay không.",
    includeLateAttendanceOption: "Tính cả lần tham dự muộn",
    excludeLateAttendanceOption: "Không tính lần tham dự muộn",
    classOpeningFeeTooltipTitle: "Quy tắc tính phí mở lớp và hoa hồng",
    classOpeningFeeTierHeader: "Quy mô lớp",
    classOpeningFeeHeader: "Phí mở lớp",
    commissionRateHeader: "Hoa hồng",
    free: "Miễn phí",
  },
  allCourses: {
  ...
  student: {
    myLearningOverview: {
      ...
      cancelled: "Đã huỷ",
      home: "Trang chủ",
      myLearning: "Lớp học của tôi",
      upcomingSessions: "Buổi học sắp diễn ra",
      noUpcomingSessions: "Không có lớp học nào sắp diễn ra",
      ...
      noTime: "Chưa có giờ",
      defaultClassTitle: "Lớp học",
      defaultCourseTitle: "",
      unassigned: "Chưa phân công",
      copiedLink: "Đã sao chép link lớp học!",
      viewAll: "Xem tất cả",
    ...
    tabCourses: "Khóa học",
    tabClasses: "Lớp học",
    tabTeachers: "Giảng viên",
    searchTeacherPlaceholder: "Tìm theo tên giảng viên, chuyên môn,...",
    allSubjects: "Tất cả môn học",
    sortFeatured: "Nổi bật",
    sortRating: "Đánh giá cao nhất",
    sortStudents: "Nhiều học viên nhất",
    sortNewest: "Mới tham gia",
    reviewsCount: "({{count}} đánh giá)",
    noReviews: "Chưa có đánh giá",
    studentsCount: "{{count}} học viên",
    openClassesCount: "{{count}} lớp đang mở",
    viewProfile: "Xem trang cá nhân",
    showingTeachers: "Hiển thị {{count}} trên {{total}} giảng viên",
    noTeachersFound: "Không tìm thấy giảng viên",
    noTeachersFoundDesc: "Thử thay đổi từ khóa tìm kiếm hoặc bộ lọc môn học.",
    defaultTeacherHeadline: "Giảng viên ngôn ngữ",
    verifiedBadge: "Giảng viên được xác minh bởi Cat Speak",
    sendMessage: "Nhắn tin",
    follow: "Theo dõi",
    following: "Đang theo dõi",
    unfollow: "Bỏ theo dõi",
    followSuccess: "Đã theo dõi giảng viên",
    unfollowSuccess: "Đã hủy theo dõi giảng viên",
    unfollowConfirmTitle: "Bỏ theo dõi giảng viên",
    unfollowConfirmMessage: "Bạn có chắc chắn muốn bỏ theo dõi giảng viên {{name}}?",
    ratingLabel: "Đánh giá",
    basedOnReviews: "Dựa trên {{count}} nhận xét",
    yearsExp: "{{count}} Năm KN",
    teachingExp: "Kinh nghiệm giảng dạy",
    openedCourses: "Khóa học đã mở",
    aboutMe: "Giới thiệu bản thân",
    lastUpdated: "Cập nhật lần cuối: {{time}}",
    viewCompetencyProfile: "Xem thêm hồ sơ năng lực",
    openClasses: "Lớp học đang mở",
    viewAllClassesCount: "Xem tất cả ({{count}} lớp)",
    startDate: "BẮT ĐẦU",
    enrollmentDeadline: "Hạn chót",
    formatOnline: "Trực tuyến Cat Speak",
    classCapacity: "Sĩ số phòng",
    level: "Trình độ",
    enrollmentTime: "Thời gian đăng ký",
    format: "Hình thức",
    viewDetails: "Xem chi tiết",
    collapseDetails: "Thu gọn",
    registerNow: "Đăng ký ngay",
    studentReviews: "Đánh giá từ học viên",
    featuredReviews: "NHẬN XÉT TIÊU BIỂU",
    viewAllReviews: "Xem tất cả nhận xét",
    noClassesOpen: "Hiện tại giảng viên chưa có lớp học nào đang mở.",
    noReviewsYet: "Chưa có nhận xét nào từ học viên.",
    openClassesOfTeacher: "Lớp học đang mở của {{name}} ({{count}})",
    reviewsAboutTeacher: "Nhận xét về {{name}} ({{count}})",
    noMatchingReviews: "Không tìm thấy nhận xét phù hợp với điều kiện lọc.",
    filterByStars: "Lọc theo số sao",
    sortReviews: "Sắp xếp nhận xét",
    competencyProfile: "Hồ sơ năng lực",
    backToTeacherProfile: "Quay lại trang giảng viên",
    teachingMottoTitle: "Triết lý giảng dạy",
    certificatesCredentials: "Chứng chỉ & Bằng cấp",
    educationTitle: "Học vấn",
    teachingExpTitle: "Kinh nghiệm giảng dạy",
    teachingMethodsTitle: "Phương pháp giảng dạy",
    teacherNotFound: "Không tìm thấy giảng viên",
    teacherNotFoundDesc: "Giảng viên bạn đang tìm kiếm không tồn tại hoặc đã ngừng hoạt động.",
    backToExplore: "Khám phá khóa học",
    ...
    enrollmentStatusClosed: "Đã đóng đăng ký",
    priceRange: "Khoảng giá",
    filterByPrice: "Lọc Theo Học Phí",
    quickPresets: "Gợi ý nhanh",
    allPrices: "Tất cả giá",
    under500k: "Dưới 500.000 đ",
    range500kTo2M: "500k - 2 triệu",
    above2M: "Trên 2 triệu",
    customPriceRange: "Tùy chỉnh khoảng giá",
    priceFrom: "Từ (VNĐ)",
    priceTo: "Đến (VNĐ)",
  ...
  createAssignment: {
    ...
    saveDraft: "Lưu nháp",
    postToFeed: "Đăng lên giảng đường",
    btnCancel: "Hủy",
  ...
  createExam: {
    validation: {
      invalidForm: "Thông tin bài kiểm tra chưa hợp lệ. Vui lòng kiểm tra lại.",
  ...
  grading: {
    ...
    postToLectureHall: "Đăng lên Giảng đường",
    editBtn: "Chỉnh sửa",
    ...
    studentTab: {
      ...
      awaitingScore: "Đang chờ điểm",
      viewDetails: "Xem chi tiết",
      startTask: "Bắt đầu",
      closed: "Đã đóng",
      timeLeftDaysHours: "Còn {{days}} ngày {{hours}} giờ",
      timeLeftHours: "Còn {{hours}} giờ",
      timeLeftMins: "Còn {{mins}} phút",
      deadline: "Hạn {{date}}",
      statusReturned: "Đã trả bài (kèm điểm)",
    },
    filterAll: "Tất cả",
    ...
    teachingTaskRequired: "Cần làm",
    teachingTaskLater: "Xử lý sau",
    teachingTaskGradeQuiz: "Chấm bài kiểm tra",
    teachingTaskGradeAssignment: "Chấm bài nộp",
    submissionNeedToGrade: "Bài nộp",
    pendingSubmissionCount: "{{count}} bài nộp",
    statusUnknown: "Không xác định",
    previousPage: "Trang trước",
    nextPage: "Trang sau",
    ...
    teacherQuiz: {
      ...
      all: "Tất cả",
      filter: "Bộ lọc",
      filterGradingStatus: "Lọc theo trạng thái chấm điểm",
      filterModalTitle: "Bộ lọc bài nộp",
      filterScored: "Có điểm",
      filterSubmissionStatus: "Lọc theo trạng thái nộp bài",
      filterSubmittedTime: "Sắp xếp theo thời gian nộp",
      filterUnscored: "Chưa có điểm",
      apply: "Áp dụng",
      reset: "Đặt lại",
      ...
      sortScore: "Sắp xếp theo điểm / lọc",
      sortScoreAsc: "Điểm: Thấp → Cao",
      sortScoreDesc: "Điểm: Cao → Thấp",
      sortTimeNewest: "Mới nhất",
      sortTimeOldest: "Cũ nhất",
      studentHasNotSubmitted: "Học viên chưa nộp bài",
      submittedTime: "Thời gian nộp",
      thAction: "Thao tác",
      thGradingStatus: "Trạng thái chấm điểm",
      thScore: "Điểm",
      thStudentInfo: "Thông tin học viên",
      thSubmissionStatus: "Trạng thái nộp bài",
      thSubmittedTime: "Thời gian nộp",
  ...
  publicClass: {
    ...
    scheduleWithModified: "{{schedule}} cộng thêm\n{{count}} buổi đặc biệt",
    andModifiedSessions: "cộng thêm {{count}} buổi đặc biệt",
    modifiedSession: "Buổi đặc biệt",
    modifiedSessionLegend: "Buổi đặc biệt",
