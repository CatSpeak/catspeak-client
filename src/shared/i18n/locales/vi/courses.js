export default {
  ...
  taskTabLater: "Để sau",
  taskColCoverImage: "Ảnh đại diện",
  taskColBelongsToCourse: "Thuộc khóa học",
  taskColTaskDescription: "Mô tả việc",
  taskColDueTime: "Giờ hết",
  taskColDueDate: "Ngày hết",
  taskColAction: "Hành động",
  taskViewDetails: "Xem chi tiết",
  taskPendingCount: "Còn {{count}} bài",
  taskLoadError: "Không thể tải danh sách công việc. Vui lòng thử lại.",
  taskNoResults: "Không có công việc nào.",
  taskRetry: "Thử lại",
  priceLabel: "Giá cả",
  free: "Miễn phí",
  ...
  dashboard: {
    ...
    sections: {
      students: "Học viên",
      studentsSubtitle: "Tình hình học viên trong kỳ đang chọn",
      studentGrowth: "Tăng trưởng học viên",
      topStudents: "Top 3 lớp theo học viên",
      revenue: "Doanh thu",
      revenueSubtitle: "Doanh thu phát sinh trực tiếp ở cấp lớp học",
      revenueTrend: "Xu hướng doanh thu",
      topRevenue: "Top 3 lớp theo doanh thu",
      performance: "Hiệu quả giảng dạy",
      performanceSubtitle: "Snapshot vận hành trong kỳ",
      sessionVolume: "Buổi học theo trạng thái",
      courseClass: "Khóa học & Lớp học",
      courseClassSubtitle: "Hiệu quả vận hành và mức độ lấp đầy",
      topFillRate: "Top 3 lớp theo tỷ lệ lấp đầy",
      quality: "Chất lượng giảng dạy",
      qualitySubtitle: "Chất lượng sau học và sức hút trước học",
  ...
  studentCourseDetail: {
    ...
    registeredStudentsLabel: "Số người đã đăng ký",
    levelLabel: "Trình độ",
    defaultLevel: "Cơ bản",
  ...
  grading: {
    ...
    postToLectureHall: "Đăng giảng đường",
    editBtn: "Chỉnh sửa",
    ...
    studentTab: {
      ...
      awaitingScore: "Chờ công bố điểm",
      viewDetails: "Xem chi tiết",
      startTask: "Làm bài",
      closed: "Đã đóng",
    ...
    teacherQuiz: {
      ...
      filter: "Lọc",
      filterGradingStatus: "Lọc trạng thái chấm",
      filterModalTitle: "Bộ lọc bài nộp",
      filterScored: "Có điểm",
      filterSubmissionStatus: "Lọc trạng thái nộp",
      filterSubmittedTime: "Sắp xếp thời gian nộp",
      ...
      thAction: "HÀNH ĐỘNG",
      thGradingStatus: "TRẠNG THÁI CHẤM",
      thScore: "ĐIỂM",
      thStudentInfo: "THÔNG TIN HỌC VIÊN",
      thSubmissionStatus: "TRẠNG THÁI NỘP",
      thSubmittedTime: "THỜI GIAN NỘP",
