export default {
  ...
  createCourse: {
    ...
    selectImage: "Chọn ảnh bìa khóa học",
    avatarPreviewAlt: "Xem trước ảnh bìa khóa học",
    toastInvalidImage: "Vui lòng chọn ảnh JPG, PNG hoặc WebP.",
    toastImageReadFail: "Không thể đọc ảnh đã chọn.",
    descriptionTooLong: "Mô tả không được vượt quá 150 từ.",
    loadFailed: "Không thể tải biểu mẫu khóa học. Vui lòng thử lại.",
    retry: "Thử lại",
    toastEnterCourseName: "Vui lòng nhập tên khóa học!",
    toastSelectLanguage: "Vui lòng chọn ngôn ngữ!",
    toastEnterDescription: "Vui lòng nhập mô tả khóa học!",
    toastUploadAvatar: "Vui lòng tải ảnh đại diện khóa học!",
