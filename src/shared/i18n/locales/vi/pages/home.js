export default {
  ...
  heroTitle1: "Nền tảng giao tiếp",
  heroTitle2: "cộng đồng đa ngôn ngữ",
  heroSubtitle:
  ...
  values: {
    ...
    community: {
      ...
      description: "Thực hành giao tiếp cùng cộng đồng năng động, đa văn hóa.",
    },
    networking: {
  ...
  aiSection: {
    ...
    languageOptions: ["Tiếng Việt", "Anh", "Trung Quốc"],
  },
  responseSection: {
    title: "Phản hồi",
