export default {
  ...
  viewAll: "View all",
  allTeachingTasksTitle: "Teaching Tasks",
  taskTabUrgent: "Urgent",
  taskTabRequired: "Required",
  taskTabLater: "Later",
  taskColCoverImage: "Cover Image",
  taskColBelongsToCourse: "Belongs to Course",
  taskColTaskDescription: "Task Description",
  taskColDueTime: "Due Time",
  taskColDueDate: "Due Date",
  taskColAction: "Actions",
  taskViewDetails: "View Details",
  taskPendingCount: "{{count}} pending",
  taskLoadError: "Could not load teaching tasks. Please try again.",
  ...
  analytics: {
    ...
    classDetail: {
      ...
      metaSubtitle: "STB Details · {{term}} · {{students}} students · {{sessions}} sessions",
      ...
      expectedThresholdHint: "Expected threshold: each student speaks ≥ {{rate}}% time (expected balance 1/{{total}} students)",
      session: "Session",
      teacherTalk: "Teacher",
      studentTalk: "Student",
      wordsCount: "{{count}} words",
      colDate: "Date",
      colEndTime: "Ended Time",
      colRatio: "Teacher / Student Ratio",
      colAvgStb: "Avg STB",
      colStatus: "Status",
      sessionNotEnded: "In progress",
      noSessions: "No session data recorded yet.",
      details: "Details",
      drawerTitle: "Student Speaking History",
      drawerAvg: "Average STB",
      drawerSessions: "Sessions Attended",
      drawerMetRatio: "Target Met Ratio",
      timeline: "Session Progress Timeline",
      close: "Close",
    },
    studentDetail: {
      breadcrumbClass: "Class Details",
      historyTitle: "Speaking History — {{name}}",
      historySubtitle: "{{className}} · {{term}} · {{sessions}} sessions attended",
      avgSpeechPercent: "% Avg Speech",
      classExpected: "Class expected: {{rate}}%",
      sessionsMetThreshold: "Sessions Met Threshold",
      showingRecentSessions: "Showing last {{count}} sessions",
      totalSpeakingDuration: "Total Speaking Duration",
      avgDurationPerSession: "Average {{avg}}/session",
      recentTrend: "Recent Trend",
      trendImproving: "Improving",
      trendStable: "Stable",
      trendDeclining: "Declining",
      recentSessionResult: "Session {{session}}: only reached {{rate}}%",
      recentSessionResultGood: "Session {{session}}: reached {{rate}}%",
      latestSessionResult: "Latest session: only reached {{rate}}%",
      latestSessionResultGood: "Latest session: reached {{rate}}%",
      latestSessionAvg: "Latest session: {{rate}}%",
      warningBanner: "This student did not meet the threshold in {{unmet}}/{{total}} recent sessions and is trending downward — consider offering additional support.",
      sectionHistory: "Session-by-session Speaking History",
      colSession: "Session",
      colDate: "Date",
      colEndTime: "Ended Time",
      colDuration: "Total Speaking Duration",
      colSpeechPercent: "% Speech",
      colExpected: "Expected",
      colStatus: "Status",
      statusMet: "Met",
      statusUnmet: "Unmet",
      showingSessionsCount: "Showing {{count}} / {{total}} sessions",
      prev: "← Previous",
      next: "Next →",
    },
    sessionDetail: {
      ...
      timePrefix: "Time:",
      loading: "Loading session analytics data...",
      aggregatingTitle: "Session data is currently aggregating",
      aggregatingDesc: "This session needs a short time to close completely and aggregate speaking metrics. Please check back shortly.",
      kpiSpeechRatio: "Speech Ratio (Teacher / Student)",
      kpiTotalDuration: "Total Speaking Duration",
      kpiParticipatingStudents: "Participating Students",
      teacherTag: "Teacher",
      studentTag: "Student",
      durationHint: "Student discussion duration",
      durationPrefix: "Duration:",
      studentsUnit: "students",
      belowThresholdCount: "{{count}} students below threshold",
      zeroBelowThreshold: "0 students below threshold",
      statusIdeal: "Status: Ideal",
      statusTooMuch: "Status: Talked too much",
      statusTooLittle: "Status: Talked too little",
      statusNormal: "Status: Normal",
      tableTitle: "Student Speaking Data",
      tableDesc: "Detailed statistics on duration and speaking status for each student in the session.",
      colStudent: "Student",
      colSpeechPercent: "% Speech (STB)",
      colSpeakingDuration: "Speaking Duration",
      colStatus: "Status",
      statusMet: "✓ Met",
      statusUnmet: "Unmet",
      noStudentData: "No student speech data recorded for this session yet.",
    },
  },
  dashboard: {
    title: "Dashboard",
    ...
    metrics: {
      ...
      hours: "hours",
      sessions: "sessions",
      platformFeeRate: "Platform fee 5%",
    ...
    sections: {
      students: "Students",
      studentsSubtitle: "Overview of students in the selected period",
      studentGrowth: "Student Growth",
      topStudents: "Top 3 Classes by Students",
      revenue: "Revenue",
      revenueSubtitle: "Revenue generated directly at class level",
      revenueTrend: "Revenue Trend",
      topRevenue: "Top 3 Classes by Revenue",
      performance: "Teaching Performance",
      performanceSubtitle: "Operational snapshot for this period",
      sessionVolume: "Sessions by Status",
      courseClass: "Courses & Classes",
      courseClassSubtitle: "Operational efficiency and class fill rates",
      topFillRate: "Top 3 Classes by Fill Rate",
      quality: "Teaching Quality",
      qualitySubtitle: "Quality after learning and appeal before enrollment",
  ...
  studentCourseDetail: {
    ...
    registeredStudentsLabel: "Registered Students",
  ...
  classDetail: {
    ...
    noStudentsHint: "Invite students to join this class to get started.",
    assistantLabel: "Teaching Assistant",
    resultsCount: "{{count}} results",
    clearSearch: "Clear search",
    viewProfile: "View profile",
    sortAsc: "Sort ascending by name (A-Z)",
    sortDesc: "Sort descending by name (Z-A)",
  ...
  createCourse: {
    ...
    avatarDesc2: "PNG, JPG, WEBP (up to 5MB)",
  ...
  createClass: {
    ...
    toastInvalidImage: "Please choose a JPG, PNG, or WebP image.",
    toastFileTooLarge: "Image size must not exceed 5MB!",
    ...
    avatarDesc1: "Supports PNG, JPEG, and WebP formats",
    avatarDesc2: "Maximum size 5MB",
    editClass: "Edit Class",
    ...
    noScheduleSelected: "No schedule configured yet.",
    reopenClass: "Reopen Class (Recover)",
    classInformation: "Class Information",
    ...
    requireMinAttendanceTooltip: "Students must attend at least this percentage of sessions to be eligible to complete the class.",
    minAttendanceRateLabel: "Minimum Attendance Rate",
    requireAttendanceTypeLabel: "Attendance Calculation Type",
    requireAttendanceTypeTooltip: "Determines how late arrivals are treated: whether they count toward attendance or not.",
    includeLateAttendanceOption: "Include late attendance",
    excludeLateAttendanceOption: "Exclude late attendance",
    classOpeningFeeTooltipTitle: "Class Opening Fee & Commission Rules",
    classOpeningFeeTierHeader: "Class Size",
    classOpeningFeeHeader: "Opening Fee",
    commissionRateHeader: "Commission",
    free: "Free",
  },
  allCourses: {
    title: "All Courses",
  ...
  student: {
    ...
    searchTeacherPlaceholder: "Search by teacher name, specialty...",
    ...
    studentsCount: "{{count}} students",
    openClassesCount: "{{count}} open classes",
    viewProfile: "View Profile",
    showingTeachers: "Showing {{count}} of {{total}} teachers",
    noTeachersFound: "No teachers found",
    noTeachersFoundDesc: "Try adjusting your search terms or subject filter.",
    defaultTeacherHeadline: "Language Teacher",
    verifiedBadge: "Teacher verified by Cat Speak",
    sendMessage: "Message",
    follow: "Follow",
    following: "Following",
    unfollow: "Unfollow",
    followSuccess: "Followed teacher successfully",
    unfollowSuccess: "Unfollowed teacher",
    unfollowConfirmTitle: "Unfollow Teacher",
    unfollowConfirmMessage: "Are you sure you want to unfollow {{name}}?",
    ratingLabel: "Rating",
    basedOnReviews: "Based on {{count}} reviews",
    yearsExp: "{{count}} Yrs Exp",
    teachingExp: "Teaching Experience",
    openedCourses: "Courses Created",
    aboutMe: "About Me",
    lastUpdated: "Last updated: {{time}}",
    viewCompetencyProfile: "View Competency Profile",
    openClasses: "Open Classes",
    viewAllClassesCount: "View all ({{count}} classes)",
    startDate: "START",
    enrollmentDeadline: "Deadline",
    formatOnline: "Online Cat Speak",
    classCapacity: "Room Capacity",
    level: "Level",
    ...
    noClassesOpen: "Currently this teacher has no open classes.",
    noReviewsYet: "No student reviews yet.",
    openClassesOfTeacher: "Open classes of {{name}} ({{count}})",
    reviewsAboutTeacher: "Reviews about {{name}} ({{count}})",
    noMatchingReviews: "No reviews found matching the filter criteria.",
    filterByStars: "Filter by stars",
    sortReviews: "Sort reviews",
    competencyProfile: "Competency Profile",
    backToTeacherProfile: "Back to Teacher Profile",
    teachingMottoTitle: "Teaching Philosophy",
    certificatesCredentials: "Certificates & Credentials",
    educationTitle: "Education",
    teachingExpTitle: "Teaching Experience",
    teachingMethodsTitle: "Teaching Methods",
    teacherNotFound: "Teacher Not Found",
    teacherNotFoundDesc: "The teacher you are looking for does not exist or is currently inactive.",
    backToExplore: "Explore Courses",
  ...
  grading: {
    ...
    viewPost: "View Post",
    postToLectureHall: "Post to Lecture Hall",
    editBtn: "Edit",
    ...
    studentTab: {
      ...
      timeLeftHours: "{{hours}}h left",
      timeLeftMins: "{{mins}}m left",
      deadline: "Deadline {{date}}",
      statusReturned: "Returned (with score)",
    },
    filterAll: "All",
    ...
    teacherQuiz: {
      ...
      all: "All",
      filter: "Filters",
      filterGradingStatus: "Filter by grading status",
      filterModalTitle: "Submission Filters",
      filterScored: "Scored",
      filterSubmissionStatus: "Filter by submission status",
      filterSubmittedTime: "Sort by submission time",
      ...
      noScore: "No score",
      sortDefault: "Default",
      sortScore: "Sort by score / filter",
      sortScoreAsc: "Score: Low → High",
      sortScoreDesc: "Score: High → Low",
      sortTimeNewest: "Newest",
      sortTimeOldest: "Oldest",
      studentHasNotSubmitted: "Student has not submitted",
      submittedTime: "Submitted time",
      thAction: "Actions",
      thGradingStatus: "Grading Status",
      thScore: "Score",
      thStudentInfo: "Student Info",
      thSubmissionStatus: "Submission Status",
      thSubmittedTime: "Submitted Time",
      flag: "Flag question",
      fromDate: "From {{date}}",
      goBack: "Go back",
  ...
  publicClass: {
    ...
    scheduleWithModified: "{{schedule}} plus\n{{count}} modified sessions",
    andModifiedSessions: "plus {{count}} modified sessions",
    modifiedSession: "Modified session",
    modifiedSessionLegend: "Modified session",
