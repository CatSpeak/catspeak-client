export default {
  ...
  taskLoadError: "Failed to load teaching tasks. Please try again.",
  ...
  dashboard: {
    ...
    metrics: {
      ...
      hours: "hrs",
      sessions: "sessions",
      platformFeeRate: "5% platform fee",
    ...
    sections: {
      students: "Students",
      studentsSubtitle: "Student overview for the selected period",
      studentGrowth: "Student Growth",
      topStudents: "Top 3 Classes by Students",
      revenue: "Revenue",
      revenueSubtitle: "Revenue generated directly at the class level",
      revenueTrend: "Revenue Trend",
      topRevenue: "Top 3 Classes by Revenue",
      performance: "Teaching Performance",
      performanceSubtitle: "Operational snapshot in this period",
      ...
      quality: "Teaching Quality",
      qualitySubtitle: "Post-learning quality and pre-enrollment appeal",
  ...
  grading: {
    ...
    studentTab: {
      ...
      startTask: "Start",
      closed: "Closed",
      timeLeftDaysHours: "{{days}} days {{hours}} hours left",
      timeLeftHours: "{{hours}} hours left",
      timeLeftMins: "{{mins}} mins left",
      deadline: "Due {{date}}",
      statusReturned: "Graded with Score"
    },
    filterAll: "All",
    ...
    teacherQuiz: {
      ...
      filter: "Filter",
      filterGradingStatus: "Filter grading status",
      filterModalTitle: "Submissions Filter",
      filterScored: "Has score",
      filterSubmissionStatus: "Filter submission status",
      filterSubmittedTime: "Sort submitted time",
      filterUnscored: "No score",
      apply: "Apply",
      reset: "Reset",
      ...
      thScore: "SCORE",
      thStudentInfo: "STUDENT INFORMATION",
  ...
  publicClass: {
    ...
    scheduleWithModified: "{{schedule}} and\n{{count}} exception session(s)",
    andModifiedSessions: "and {{count}} exception session(s)",
    modifiedSession: "Exception session",
    modifiedSessionLegend: "Exception session",
