export default {
  ...
  analytics: {
    ...
    studentDetail: {
      ...
      totalWordsSpoken: "Total Spoken Words",
      avgWordsPerSession: "Average {{avg}} words/session",
    ...
    sessionDetail: {
      ...
      kpiTotalWordsDuration: "Total Words & Duration",
      ...
      tableDesc: "Detailed statistics on duration, word count, and speaking status for each student in the session.",
      colStudent: "Student",
      colSpeechPercent: "% Speech (STB)",
      colSpeakingDuration: "Speaking Duration",
      colWords: "Word Count",
      colPace: "Speaking Pace",
      colStatus: "Status",
      statusMet: "✓ Met",
      statusUnmet: "Unmet",
