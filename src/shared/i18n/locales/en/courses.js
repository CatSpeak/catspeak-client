export default {
  ...
  analytics: {
    ...
    classDetail: {
      ...
      clickStudentHint: "› Click student to view speech balance history for each session",
    ...
    studentDetail: {
      ...
      statusMet: "Met",
      statusUnmet: "Unmet",
      clickSessionHint: "› Click session to view full class report for that session (sc19)",
