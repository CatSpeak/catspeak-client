export default {
  ...
  createClass: {
    ...
    toastAdmissionStartPast: "Admission start date cannot be in the past!",
    toastAdmissionEndPast: "Admission end date cannot be in the past!",
    toastStartPast: "Start date cannot be in the past!",
