export default {
  ...
  videoCall: {
    ...
    participantList: {
      ...
      hostEnabledJoinSound: "Host turned ON join/leave sound alerts.",
      hostDisabledJoinSound: "Host turned OFF join/leave sound alerts.",
      ...
      successEnableJoinSound: "Turned ON join/leave sound alerts",
