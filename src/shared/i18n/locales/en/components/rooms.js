export default {
  ...
  videoCall: {
    ...
    participantList: {
      ...
      confirmKick: "Are you sure you want to remove this participant from the room?",
      confirmBan: "Are you sure you want to remove this participant and BAN them from rejoining?",
