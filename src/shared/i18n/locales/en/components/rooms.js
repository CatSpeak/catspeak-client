export default {
  ...
  searchPlaceholder: "Search by room name, topic...",
  searchBtn: "Search",
  sortTooltip: "Sort",
  sortTitle: "Sort List",
  ...
  workspace: {
    ...
    bookmarkedRooms: "Saved Rooms",
  },
  noBookmarkedRooms: "No saved rooms yet",
  noBookmarkedRoomsDesc: "Save your favorite rooms for quick access anytime!",
  noSearchResults: "No matching results found",
  noSearchResultsDesc: "Try adjusting your search terms or filters.",
  loadError: "Unable to load rooms. Please try again.",
  retry: "Try again",
  bookmarkUpdated: "Updated saved rooms list",
  bookmarkUpdateError: "Could not update saved rooms",
  pagination: {
    prev: "Previous",
    next: "Next",
  ...
  createRoom: {
    ...
    typeCustom: "Custom",
    roomTypeLabel: "Room type",
    typeGroupDesc: "Temporary room, up to 5 people",
    typeCustomDesc: "Persistent room, up to {max} people",
    formHint: "Enter the basic information to create your room",
    topicSelected: "{{count}}/{{max}} selected",
  ...
  chatBox: {
    ...
    aiMeetingSuggestionLabel: "CONVERSATION STARTERS",
    aiGreetingIntro: "Hello! Here are suggested sentences for today's session topic to practice speaking or ask AI for related vocabulary:",
    aiAskVocabularyTooltip: "Click to ask AI for related vocabulary",
    aiAskVocabularyPrompt: 'Suggest suitable vocabulary commonly used for the sentence: "{{sentence}}"',
    aiLoadMoreSuggestions: "+ Load more suggestions",
    aiTopicLabel: "Topic:",
    aiPublicWarningBadge: "🌐 Shared with room",
    aiPlaceholderDynamic: "Ask anything about {language}...",
    aiRetry: "Retry",
  ...
  customRooms: {
    expiredWarning: "Expired — will be deleted",
    assignedCoHost: "Co-host assigned",
    noCoHost: "No Co-host",
    ...
    formHint: "Set up the details for your custom room",
    sectionBasic: "Basic information",
    sectionSettings: "Room settings",
  },
  aiSettings: {
  ...
  waitingScreen: {
    ...
    deviceSettingsTab: "Device settings",
    generalTab: "General",
    myPreferences: "My preferences",
    bannedListTab: "Banned list",
    ...
    micTestHint: "Press Test mic and say a few words to see the level.",
    micTestListening: "Say a few words...",
    micTestDetected: "Audio detected",
  ...
  videoCall: {
    ...
    watchTogether: {
      toggleButton: "Watch together",
      title: "Watch together",
      inputLabel: "Paste a YouTube link",
      startButton: "Play video for the room",
      starting: "Starting...",
      stopButton: "Stop video",
      stopping: "Stopping...",
      invalidUrl: "Please enter a valid YouTube link.",
      hostOnly: "Only the room host can play a shared video.",
      startSuccess: "Playing video for the room...",
      stopSuccess: "Shared video stopped.",
      startError: "Could not play the video. Please try again.",
      ...
      embedBlocked: "This video does not allow watch-together.",
      syncError: "Could not load the video. Check your connection and try again.",
      switchButton: "Switch to this video",
      switchLabel: "Paste a new YouTube link to switch",
    ...
    general: {
      ...
      allowMemberRecording: "Allow members to record the meeting",
      allowMemberRecordingDesc:
        "When disabled, members cannot use the platform record feature and video will be blacked out if captured by external screen recorders (audio remains unaffected).",
      allowMemberPrivateAi: "Allow members to use Private AI Chat",
      allowMemberPrivateAiDesc:
        "When disabled, members can only use Public AI Chat in the meeting room and cannot have private chats with the AI.",
      allowGame: "Allow games in the room",
      allowGameDesc:
        "When disabled, members cannot start a new game. Ongoing games continue.",
      allowHighQuality: "High quality mode (720p)",
      allowHighQualityDesc: "When on, participants publish camera at 720p. Foreign participants still receive at most 2 video tiles.",
      privateAiDisabledByHost: "Host has disabled Private AI Chat for members.",
    },
    ...
    controls: {
      ...
      participants: "Participants",
      speakingTimeBalance: "Speaking Time Balance",
      chat: "Chat",
      captionsOn: "Turn on captions",
      captionsOff: "Turn off captions",
    ...
    speakingTimeBalance: {
      ...
      colName: "Name",
      colPercent: "%",
      roomStudents: "Room Students ({count})",
      normal: "Normal",
      attention: "Needs attention",
      tooLow: "Too low",
      noDataTitle: "No one has spoken yet",
      noDataSubtitle: "The session just started",
      errorTitle: "Data collection error",
      errorSubtitle: "Session is still ongoing",
      errorCode: "E-stb-001 · Auto recovery",
      errorFooter: "System will automatically recover data once connection restores",
      unableToLoad: "Unable to load",
      studentWidget: {
        meMainRoom: "Me: Main Room",
        meBreakout: "Me: {name}",
        speakingPercent: "% speaking",
        cumulativeDuration: "speaking duration",
        personalMetrics: "Personal metrics",
        errorSpeakingPercent: "% Spk",
        errorDuration: "Duration",
        errorCannotGet: "Unable to get data",
      },
    },
    ...
    participantList: {
      ...
      roomPoliciesTitle: "Room Policies & Permissions",
      back: "Back",
      searchPlaceholder: "Search participants...",
      noSearchResults: "No participants found.",
      raisedHandsSection: "Raised hands",
      membersSection: "In the room",
      dangerZone: "Danger zone",
      endLiveDesc: "End the live session for all students and participants.",
      endLiveDescRoom: "Close the room and end the session for all members.",
      restrictVoiceAllDesc: "Mute all attendees and prevent them from unmuting.",
      restrictVoiceAllDescRoom: "Mute all members and prevent them from unmuting.",
      bannedTabShort: "Banned",
      groupStudentPermissions: "Student permissions",
      groupStudentPermissionsRoom: "Member permissions",
      groupRoomSecurity: "Room & recording",
      forbiddenGame: "You do not have permission to change the game policy.",
      forbiddenHighQuality: "Only the host can turn high-quality mode on or off.",
      forbiddenBannedList: "You do not have permission to view this room's banned list.",
      you: "You",
      guest: "Guest",
      youSuffix: "(You)",
      micOn: "Microphone on",
      ...
      muteCam: "Turn off camera",
      unmuteCam: "Turn on camera for them",
      stopScreenShare: "Stop screen share",
      kick: "Remove from room",
      ban: "Remove & Ban from rejoining",
      confirmMuteAllTitle: "Mute all",
      confirmKickTitle: "Remove from room",
      confirmBanTitle: "Remove & Ban from rejoining",
      confirmMuteAll: "Are you sure you want to mute all participants in the room?",
      confirmKick: "Are you sure you want to remove {name} from the room?",
      confirmBan: "Are you sure you want to ban {name} from the room?",
      restrictChat: "Restrict chat",
      unrestrictChat: "Lift chat restriction",
      restrictVoice: "Restrict voice",
      unrestrictVoice: "Lift voice restriction",
      restrictVoiceAll: "Block all mics",
      restrictVoiceAllRoom: "Block all mics",
      confirmRestrictChatTitle: "Restrict chat",
      confirmRestrictChat:
        "Are you sure you want to restrict {name} from sending chat messages?",
      confirmUnrestrictChatTitle: "Lift chat restriction",
      confirmUnrestrictChat:
        "Are you sure you want to lift the chat restriction for {name}?",
      confirmRestrictVoiceTitle: "Restrict voice",
      confirmRestrictVoice:
        "Are you sure you want to restrict {name} from speaking?",
      confirmUnrestrictVoiceTitle: "Lift voice restriction",
      confirmUnrestrictVoice:
        "Are you sure you want to lift the voice restriction for {name}?",
      confirmRestrictVoiceAllTitle: "Restrict voice for all",
      confirmRestrictVoiceAllTitleRoom: "Mute all members",
      confirmRestrictVoiceAll:
        "Are you sure you want to restrict voice for {count} participants in the room? They will not be able to unmute themselves until it is lifted.",
      confirmRestrictVoiceAllRoom:
        "Are you sure you want to mute {count} members in the room? They will not be able to unmute themselves until it is lifted.",
      successRestrictChat: "Chat restricted",
      successUnrestrictChat: "Chat restriction lifted",
      successRestrictVoice: "Voice restricted",
      successUnrestrictVoice: "Voice restriction lifted",
      successRestrictVoiceAll: "Voice restricted for {count} participants",
      successRestrictVoiceAllRoom: "Muted {count} members",
      participantNotFound:
        "The participant has left the room. Refreshing the list.",
      alreadyRestricted: "Already in that state.",
      noActiveSession: "No live session is in progress.",
      alreadyVoiceRestricted: "Already in the restricted state.",
      forbiddenRestrictVoice: "You do not have permission to restrict voice.",
      forbiddenModerate: "You do not have permission to perform this action.",
      hostMutedMic: "Host muted your microphone.",
      hostMutedCam: "Host turned off your camera.",
      hostUnmutedMic: "Host turned on your microphone.",
      hostUnmutedCam: "Host turned on your camera.",
      hostStoppedScreen: "Host stopped your screen sharing.",
      hostMutedAll: "Host muted everyone in the room.",
      allowSelfUnmute: "Allow students to unmute themselves",
      allowSelfUnmuteRoom: "Allow members to unmute themselves",
      selfUnmuteOn: "Students can now unmute themselves.",
      selfUnmuteOnRoom: "Members can now unmute themselves.",
      selfUnmuteOff: "Students can no longer unmute themselves.",
      selfUnmuteOffRoom: "Members can no longer unmute themselves.",
      selfUnmuteBlocked: "Host disabled self-unmute. Please wait for host to unmute you.",
      allowSelfCamera: "Allow students to turn on their camera",
      allowSelfCameraRoom: "Allow members to turn on their camera",
      selfCameraOn: "Students can now turn on their camera.",
      selfCameraOnRoom: "Members can now turn on their camera.",
      selfCameraOff: "Students can no longer turn on their camera.",
      selfCameraOffRoom: "Members can no longer turn on their camera.",
      selfCameraBlocked:
        "Host disabled self-camera. Please wait for the host to turn it on.",
      forbiddenMedia: "You do not have mic/camera control permission.",
      forbiddenMuteAll: "You do not have mute-all permission.",
      forbiddenSelfUnmute: "You do not have permission to change this policy.",
      forbiddenSelfCamera: "You do not have permission to change this policy.",
      allowStudentShare: "Allow students to share screen",
      allowStudentShareRoom: "Allow members to share screen",
      studentShareOn: "Students can now share their screen.",
      studentShareOnRoom: "Members can now share their screen.",
      studentShareOff: "Students can no longer share their screen.",
      studentShareOffRoom: "Members can no longer share their screen.",
      studentShareBlocked: "Host disabled student screen sharing.",
      forbiddenStudentShare: "You do not have permission to change this policy.",
      allowMemberRecording: "Allow students to record",
      allowMemberRecordingRoom: "Allow members to record",
      memberRecordingOn: "Students can now record the meeting.",
      memberRecordingOnRoom: "Members can now record the meeting.",
      memberRecordingOff: "Students can no longer record the meeting.",
      memberRecordingOffRoom: "Members can no longer record the meeting.",
      memberRecordingBlocked: "Host disabled recording for members.",
      forbiddenRecord: "You do not have permission to manage recording.",
      shareDeniedNoPerm: "You do not have screen-share permission.",
      forbiddenStopScreen: "You do not have permission to stop screen shares.",
      hostLoweredAllHands: "Host lowered all raised hands.",
      hostAllowedRecording: "Host ALLOWED members to record the meeting.",
      hostDisabledRecording: "Host DISABLED meeting recording for members.",
      hostAllowedPrivateAi: "Host ALLOWED members to use Private AI Chat.",
      hostDisabledPrivateAi: "Host DISABLED Private AI Chat for members.",
      kickedByHost: "You have been removed from the room by the Host.",
      successMuteAll: "Muted all participants",
      cameraOffAll: "Turn off all cameras",
      cameraOffAllRoom: "Turn off all members' cameras",
      cameraOffAllDesc: "Turn off the camera of every student in the room.",
      cameraOffAllDescRoom: "Turn off the camera of every member in the room.",
      confirmCameraOffAllTitle: "Turn off all cameras",
      confirmCameraOffAll:
        "Are you sure you want to turn off everyone's camera in the room?",
      successCameraOffAll: "Turned off everyone's camera (except you).",
      forbiddenCameraOffAll: "You do not have permission to turn off all cameras.",
      hostCameraOffAll: "The Host turned off everyone's camera in the room.",
      ...
      forbiddenLowerHands: "You do not have permission to lower hands.",
      successStopScreen: "Stopped screen share for user",
      successMuteMic: "Muted user microphone",
      successMuteCam: "Turned off user camera",
      successUnmuteMic: "Unmuted user microphone",
      successUnmuteCam: "Turned on user camera",
      successKick: "Removed user from room",
      successBan: "Removed and banned user from rejoining",
      bannedListTitle: "Banned members list",
      ...
      requireApprovalDesc: "When on, newcomers must knock and wait for the Host/Co-host to admit them.",
      requireApprovalOn: "Manual approval enabled for this room.",
      requireApprovalOff: "Manual approval disabled. Everyone can join freely.",
      forbiddenRequireApproval: "Only the room host can toggle the approval requirement.",
      hostLockedRoom: "Host locked the room. Newcomers cannot join.",
      hostUnlockedRoom: "Host unlocked the room.",
      endLive: "End live session",
      endLiveRoom: "End room",
      confirmEndLiveTitle: "End live session",
      confirmEndLiveTitleRoom: "End room",
      ...
      confirmEndLiveRoom: "End the room for everyone? Everyone returns to the end screen; rejoining starts a new session. Room and attendance stay unchanged.",
      endLiveSuccess: "Live session ended.",
      endLiveSuccessRoom: "Room ended.",
      forbiddenEnd: "You do not have permission to end the live session.",
      forbiddenEndRoom: "You do not have permission to end the room.",
    ...
    waitingQueue: {
      tab: "Waiting",
      loading: "Loading waiting list...",
      empty: "Nobody is waiting for approval.",
      userLabel: "User",
      pendingLabel: "Pending approval",
      rejectedLabel: "Previously rejected",
      enrollmentPending: "Pending enrollment approval",
      admit: "Admit",
      reject: "Reject",
      invite: "Invite",
      admitSuccess: "Admitted into the room.",
      rejectSuccess: "Rejected the join request.",
      inviteSuccess: "Invitation sent.",
      inviteFailed: "Could not send the invitation. Please try again.",
      forbiddenAdmit: "You do not have waiting-room approval permission.",
      knock: "Knock",
      knockHint: "Room uses approval mode? Knock to request entry.",
      knockTitle: "Request to join",
      knockDesc: "This room uses approval mode. Knock and wait for the host/co-host to let you in.",
      knockSuccess: "Request sent. Please wait for approval.",
      knockFailed: "Could not send the request. Please try again.",
      waitingTitle: "Waiting for approval...",
      waitingDesc: "Your request has been sent. This screen will open automatically once approved.",
      rejectedTitle: "Join request rejected",
  ...
  breakoutRooms: {
    ...
    lowSpeakingNotice: "⚠️ {count} students below speaking target",
    lowSpeakingBadge: "⚠️ {count} under target",
  ...
  coHost: {
    manage: "Manage Co-host",
    add: "Add Co-host",
    manageShort: "Manage",
    emptyShort: "No Co-host assigned",
    permissionsUpdated: "Co-host permissions updated.",
    replaced: "Co-host replaced.",
    assigned: "Co-host assigned.",
    assignError: "Failed to assign co-host. Please try again.",
    revoked: "Co-host revoked.",
    revokeError: "Failed to revoke co-host. Please try again.",
    remove: "Remove",
    assignCoHost: "Assign Co-host",
    saveChanges: "Save Changes",
    confirmRevokeTitle: "Confirm Revoke Co-host",
    confirmRevokeMessage: "Are you sure you want to revoke this co-host? This action cannot be undone.",
    confirmClearMessage: "Remove the selected user from the form?",
    clearSelection: "Remove",
    emptyClass: "No Co-host assigned to this class",
    emptyRoom: "No Co-host assigned to this room",
    revokeSuccessTitle: "Co-host removed!",
    revokeSuccessMessage: "The Co-host assignment has been successfully revoked.",
    done: "Done",
    cancel: "Cancel",
    delete: "Delete",
    saving: "Saving...",
    ...
    step2: "2. Select Permissions for Co-host",
    quickSelect: "Quick Select",
    selectAll: "Select All",
    deselectAll: "Deselect All",
    selectPermissions: "Select permissions the Co-host will have in this room",
    note: "Note:",
    noteDesc: "Co-host permissions apply per room.",
    noteDescRoom: "Co-host permissions apply per room.",
    scopeClass: 'in class "{name}"',
    scopeRoom: 'in room "{name}"',
    scopeTypeRoom: "Room",
    scopeTypeClass: "Class",
    headerSubtitle: "Assign a co-host and configure room management permissions",
    headerSubtitleRoom:
      "Assign a support member and configure room management permissions",
    userSectionTitle: "Assigned User",
    permissionSectionTitle: "Permission Settings",
    permissionsCount: "{count}/{total} permissions",
    changeUser: "Change user",
    designatedBadge: "Designated Co-host",
    inRoomStatus: "In room",
    ...
    scopeDescriptionRoom: "Select permissions the Co-host will have in this room",
    scopeDescriptionClass: "Select permissions the Co-host will have in this class",
    groupRoomSecurity: "Room Security",
    groupStudentManagementRoom: "Member Management",
    groupMemberModerationRoom: "Member Moderation",
    badgeSensitive: "Sensitive",
    badgeCaution: "Caution",
    hintNoUser: "Please select a user to assign as co-host.",
    hintNoPerms: "Please select at least 1 permission for the co-host.",
    hintNoChange: "No changes made to current permissions.",
    scopeNoticeRoom: 'Co-host permissions only apply to room "{name}".',
    scopeNoticeClass: 'Co-host permissions only apply to class "{name}".',
    permissionHelpers: {
      mic_toggle: "Allow or restrict individual participant microphones",
      camera_toggle: "Enable or disable participant cameras",
      mute_all: "Mute all students in the room at once",
      allow_self_unmute: "Allow students to unmute themselves",
      allow_self_camera: "Allow students to turn their camera back on",
      remove_student: "Remove student from the room",
      admit_waiting: "Admit students from the waiting room",
      camera_off_all: "Turn off every student's camera",
      block_all_mics: "Mute all microphones and block students from unmuting",
      lower_all_hands: "Lower the raised hand of every student",
      restrict_chat: "Stop students from sending chat messages",
      restrict_voice: "Mute a student's microphone and block unmuting",
      stop_member_share: "Stop a student's ongoing screen share",
      lock_class: "Lock the room to prevent new entries",
      end_class: "Close the room and end the session",
      share_screen: "Share screen or application window",
      manage_student_share: "Turn student screen sharing on or off",
      allow_member_recording: "Turn student self-recording on or off",
      record: "Start or stop cloud recording",
    },

    permissionHelpersRoom: {
      mic_toggle: "Allow or restrict individual participant microphones",
      camera_toggle: "Enable or disable participant cameras",
      mute_all: "Mute all members in the room at once",
      allow_self_unmute: "Allow members to unmute themselves",
      allow_self_camera: "Allow members to turn their camera back on",
      remove_student: "Remove member from the room",
      admit_waiting: "Admit members from the waiting room",
      camera_off_all: "Turn off every member's camera",
      block_all_mics: "Mute all microphones and block members from unmuting",
      lower_all_hands: "Lower the raised hand of every member",
      restrict_chat: "Stop members from sending chat messages",
      restrict_voice: "Mute a member's microphone and block unmuting",
      stop_member_share: "Stop a member's ongoing screen share",
      lock_class: "Lock the room to prevent new entries",
      end_class: "Close the room and end the session",
      share_screen: "Share screen or application window in the room",
      manage_student_share: "Turn member screen sharing on or off",
      allow_member_recording: "Turn member self-recording on or off",
      record: "Start or stop recording in the room",
    },
    groups: {
      student_management: "Student Management",
      member_moderation: "Student Moderation",
      room_security: "Class Security",
    },
    permissions: {
      mic_toggle: "Toggle student microphone",
      camera_toggle: "Toggle student camera",
      mute_all: "Mute all students",
      allow_self_unmute: "Allow students to unmute themselves",
      allow_self_camera: "Allow students to turn their camera on",
      remove_student: "Remove students from class",
      admit_waiting: "Admit students from waiting room",
      camera_off_all: "Turn off all student cameras",
      block_all_mics: "Block all student microphones",
      lower_all_hands: "Lower all students' hands",
      restrict_chat: "Restrict student chat",
      restrict_voice: "Restrict student voice",
      stop_member_share: "Stop student screen share",
      lock_class: "Lock class",
      end_class: "End class",
      share_screen: "Share screen / window",
      manage_student_share: "Manage student screen sharing",
      allow_member_recording: "Allow students to record",
      record: "Start / stop recording",
    },
    permissionsRoom: {
      mic_toggle: "Toggle member microphone",
      camera_toggle: "Toggle member camera",
      mute_all: "Mute all members",
      allow_self_unmute: "Allow members to unmute themselves",
      allow_self_camera: "Allow members to turn their camera on",
      remove_student: "Remove member from room",
      admit_waiting: "Admit members from waiting room",
      camera_off_all: "Turn off all member cameras",
      block_all_mics: "Block all member microphones",
      lower_all_hands: "Lower all members' hands",
      restrict_chat: "Restrict member chat",
      restrict_voice: "Restrict member voice",
      stop_member_share: "Stop member screen share",
      lock_class: "Lock room",
      end_class: "End room",
      share_screen: "Share screen / window",
      manage_student_share: "Manage member screen sharing",
      allow_member_recording: "Allow members to record",
      record: "Start / stop recording",
    },
    errors: {
      ...
      COHOST_TARGET_NOT_CONFIRMED_ROOM: "Only confirmed members can be co-hosts.",
