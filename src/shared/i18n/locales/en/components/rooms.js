export default {
  ...
  videoCall: {
    ...
    participantList: {
      ...
      confirmMuteAllTitle: "Mute all mics",
      ...
      restrictVoiceAll: "Restrict voice for all",
      restrictVoiceAllRoom: "Mute all members",
  ...
  coHost: {
    ...
    permissionHelpers: {
      ...
      manage_student_share: "Control student screen sharing permissions",
    ...
    permissionHelpersRoom: {
      ...
      manage_student_share: "Control member screen sharing permissions",
