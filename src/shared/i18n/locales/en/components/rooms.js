export default {
  ...
  breakoutRooms: {
    ...
    saveAndStartSuccess: "Saved configuration and started breakout rooms successfully!",
    ...
    broadcastDesc: "This message will be sent simultaneously to all breakout rooms.",
    sendBtn: "Send",
    ...
    notStartedDesc: "The teacher has not opened breakout rooms for this session yet.",
    changeLocked: "Room change locked",
    roomFull: "Room is full",
    roomPrefix: "Room ",
    returningTitle: "Returning to Main Room",
    movingTitle: "Moving to Breakout Room",
    returningDesc: "The breakout session has ended. You are being automatically moved back to the main room...",
